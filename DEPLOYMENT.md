...
| 항목 | 상태 | 비고 |
|------|------|------|
| GitHub 레포 | ✅ 완료 | vue-pivottable/nuxt |
...
1. [npmjs.com](https://www.npmjs.com) → **@vue-pivottable/nuxt** 패키지 페이지
...
- [ ] NPM에서 패키지 확인 (`npm info @vue-pivottable/nuxt`)

### OIDC 전환
- [ ] NPM → 패키지 Settings → Trusted Publishing 설정
- [ ] Repository: `vue-pivottable/nuxt`
- [ ] Workflow filename: `publish.yml`
